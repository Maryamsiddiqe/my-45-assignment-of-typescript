...
var message = "".concat(famous_person, " onse said,\"").concat(quote, "\"");
console.log(message);
//Ex# 6
...
var students = ["haya", "maryam", "ayzal", "hamdan",];
...
var students = ["haya", "daniyal", "hamza", "ayzal", "rizwana"];
var message = "Good Morning I hope You Are Enjoying alot:";
...
var favoriteTransportation = ["motorcycle", "car", "train", "bus",];
...
var guestList = ["zobia", "aiza", "zearish"];
...
var abscentPerson = "aiza";
var newGuest = "khadija";
guestList[1] = newGuest;
for (var i = 0; i < guestList.length; i++) {
    console.log("hello Dear " + guestList[i] + ", \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!");
}
console.log("Miss.".concat(abscentPerson, " will not come tomorrow dinnr."));
//Ex# 16
...
while (guestList.length > 2) {
    ...
    console.log("sorry Madam ".concat(removeGuest, " you are not invited for dinner."));
}
for (var i = 0; i < guestList.length; i++) {
...
var places = ["Saudia Arabia", "China", "Skardo", "kyoto", "Turkey"];
...
var guestList = ["zobia", "aiza", "zearish", "haya", "maryam"];
//for(let i=0; i<guestList.length; i++){
// console.log(`hello Dear ` + guestList[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!` )
//}
...
var pakistanProvinceLanguages = ["pashto", "balochi", "sindhi", "punjabi"];
console.log("list of pakistanProvinceLanguages");
for (var _i = 0, pakistanProvinceLanguages_1 = pakistanProvinceLanguages; _i < pakistanProvinceLanguages_1.length; _i++) {
    var top_1 = pakistanProvinceLanguages_1[_i];
    console.log(top_1);
}
// create two object
var books = {
...
console.log(books);
console.log(fruits);
console.log("book name: ".concat(books.name, ", price: ").concat(books.price));
console.log("fruits name: ".concat(fruits.name, ", description: ").concat(fruits.description));
//Ex# 22
//Intentional Error: If you haven’t received an array index error in one of your programs yet, 
//try to make one happen. Change an index in one of your programs to produce an index error.
// Make sure you correct the error before closing the program.
var shoppingArray = ["dresses", " jewellery", "shoes", 4, 16, 12];
...
var favouriteFruits = ["strawberry", "mango", "dragon Fruit"];
...
var userName = ['Admin', 'Ali Phull', 'Muhammad', 'Kamran', 'Muhammad Bhuran', 'Muhammad Ali'];
function greetUsers() {
...
var user = ["maryam", "haya", "daniyal", " hadi", "admin"];
if (user.length === 0) {
...
var currentUsers = ["Maryam", "haya", "Hamdan", "Maham", "Hadi"];
var newUsers = ["Rabiya", "hamna", "Haya", "Anusha", "Hamdan"];
newUsers.forEach(function (newOneUsers) {
    var ourCondition = currentUsers.some(function (currentOneUsers) { return currentOneUsers.toLowerCase() === newOneUsers.toLowerCase(); });
    if (ourCondition) {
        console.log("sorry ".concat(newOneUsers, " is already taken"));
    }
    else {
        console.log("this userName ".concat(newOneUsers, " is avalaible"));
    }
});
// ex # 33
...
var favoritePizza = ["fajita Pizza", "cheeze Pizza", "chickenTikka Pizza"];
...
for (var i = 0; i < favoritePizza.length; i++) {
    console.log("i like to eat ".concat(favoritePizza[i]));
}
...
var album1 = make_album("maryam", "album tittle 1");
var album2 = make_album("haya", "album tittle 2");
var album3 = make_album("ayzal", "album tittle 3", 12);
...
var magician_names = ["harry houdini", "criss angel", "derren brown"];
//calling function 
...
var magicians_names = ["harry houdini", "criss angel", "derren brown"];
...
var copyMagiciansNames = magicians_names.slice();
var copyGreatMagicians = make_great(copyMagiciansNames);
...
var myCar = createCar("toyota", "corolla", ["color", "black"], ["optional features", "sunroof "]);
console.log(myCar);
